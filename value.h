...
//> sign-bit
#define SIGN_BIT ((u64int)0x8000000000000000)
//< sign-bit
#define QNAN     ((u64int)0x7ffc000000000000)
//< qnan
//> tags
...
//< as-number
//> as-obj
#define AS_OBJ(v)       ((Obj*)(uintptr)((v) & ~(SIGN_BIT | QNAN)))
//< as-obj
//> number-val
...
//< bool-val
//> false-true-vals
#define FALSE_VAL       ((Value)(u64int)(QNAN | TAG_FALSE))
#define TRUE_VAL        ((Value)(u64int)(QNAN | TAG_TRUE))
//< false-true-vals
//> nil-val
#define NIL_VAL         ((Value)(u64int)(QNAN | TAG_NIL))
//< nil-val
#define NUMBER_VAL(num) numToValue(num)
//< number-val
//> obj-val
#define OBJ_VAL(obj) \
    (Value)(SIGN_BIT | QNAN | (u64int)(uintptr)(obj))
//< obj-val
//> double-union
